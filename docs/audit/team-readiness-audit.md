...
| 3 | History rewrite | **TAMAMLANDI 2026-09-10** (645): filter-repo, 235 literal + 9 regex, HEAD ağacı aynı; `main` + 3509 tag force-push; taze klon taraması 0. Kalan **operatör**: GitHub Support gc talebi |
