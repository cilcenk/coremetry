...
Settings → API Tokens → **New token**, rol: **viewer** (24 tool'un
...
denemez). Bugün 24 tool'un tamamı `MinRole=""` (viewer tabanı; v0.9.1141'ta
beş keşif tool'u eklendi — list_operations / list_environments /
list_clusters / list_deploys / find_trace_by_span).
