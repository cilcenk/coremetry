...
import { api, type MaintenanceWindow, type CustomRole, type AvailablePage } from '@/lib/api';
...
type Tab = 'smtp' | 'channels' | 'maintenance' | 'ai' | 'tempo' | 'kibana' | 'ldap' | 'sso' | 'retention' | 'sampling' | 'anomaly' | 'branding' | 'roles';
