...
// (shop-chequenotes-notespayment), Coremetry'nin servis listesi ise
// trace'ten gelen EKLİ adı gösteriyor (...-uat). Eşleşme ancak eksiz
// adla kurulabiliyor.
//
// Bedeli: "shop-deposit-uat" ve "shop-deposit-prod" ikisi de
// "shop-deposit"e iniyor. Sunucu önce ortamla kısıtlamayı deniyor
