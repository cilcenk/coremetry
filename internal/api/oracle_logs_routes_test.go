...
func sampleOracleRow() chstore.OracleErrorRow {
	return chstore.OracleErrorRow{
		...
		HostName: "app-01", InstanceID: "shop-payment-7f9c", OperationCode: "PAY_TRANSFER", ErrorCode: "REDACTED",
		ExternalCode: "", ErrorType: "T", ChannelCode: "MOB", TaskCode: "", RequestID: "req-42",
		AttrKeys: []string{"ERR_NUM", "ERR_SQLTEXT"}, AttrValues: []string{"7", "select 1"},
	}
}
...
func TestOracleLogRowProjection(t *testing.T) {
	...
	want := map[string]string{
		"operation.code": "PAY_TRANSFER", "error.code": "REDACTED", "error.type": "T", "channel.code": "MOB",
		"request.id": "req-42", "ERR_NUM": "7", "ERR_SQLTEXT": "select 1",
	}
