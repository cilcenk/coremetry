...
func TestPollerOwnedSubject(t *testing.T) {
	cases := []struct {
		...
		{RuleExtCapPrefix + "ext:prod-eu:ext:REDACTED", "ext:prod-eu", true}, // metrik iki nokta taşır
		...
		{"anomaly:ext:prod-eu/OP1:ext:REDACTED", "", false}, // seri Problem'i — sahipli değil
