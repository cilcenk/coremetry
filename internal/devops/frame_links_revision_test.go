...
func TestResolveFrameLinks_VersionTagVerified(t *testing.T) {
	...
	got := svc.ResolveFrameLinks(context.Background(), "bsa-core-service-prod", PinRead{}, frames, "release.20260817.1")
...
func TestResolveFrameLinks_VersionTagMissingFallsBackWithNote(t *testing.T) {
	...
	got := svc.ResolveFrameLinks(context.Background(), "bsa-core-service-prod", PinRead{}, frames, "release.19990101.9")
	if got.Revision == nil || got.Revision.Verified {
...
func TestResolveFrameLinks_PlaceholderVersionSkipsResolution(t *testing.T) {
	f, svc, frames := revisionFixture(t)
	got := svc.ResolveFrameLinks(context.Background(), "bsa-core-service-prod", PinRead{}, frames, "latest")
	if got.Revision != nil {
