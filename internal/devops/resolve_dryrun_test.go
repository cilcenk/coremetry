...
func TestResolveDryRunSuccess(t *testing.T) {
	...
	res := svc.ResolveDryRun(context.Background(), "shop-core-service-prod", PinRead{})
	...
	// Konvansiyon: "shop-" öneki + "-prod" ortam eki soyulur.
	...
	// Ayarlar'daki Project açık: türetimi (SHOP) EZMELİ.
...
func TestResolveDryRunPinFailClosed(t *testing.T) {
	...
	res := svc.ResolveDryRun(context.Background(), "shop-core-service-prod",
		PinRead{Abort: abort})
...
func TestResolveDryRunDoesNotTouchCodeCounters(t *testing.T) {
	...
	svc.ResolveDryRun(ctx, "shop-core-service-prod", PinRead{})
	svc.ResolveDryRun(ctx, "legacy-service", PinRead{})
	svc.ResolveDryRun(ctx, "shop-core-service-prod", PinRead{Abort: "katalog okunamadı"})
	New().ResolveDryRun(ctx, "shop-core-service-prod", PinRead{})
