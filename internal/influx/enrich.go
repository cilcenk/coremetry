...
//      her groupBy tag'ı adıyla) → ≤50 en yeni satır (TRACEID, REDACTED,
//      REDACTED, REDACTED). Trace id 32 küçük-harf hex doğrulanır;
...
//   5. Pod'lar — REDACTED sayımı (Problem.Pod tek string; liste kanıta).
