...
// Operatör kararı 2026-09-07 (hata oranı: TFAIL ÷ toplam).
...
// (ratioKey yalnız oranın anahtarlarını okur, numBy[k] += v). Gerekçe: TFAIL
// üç boyutlu (KANALKOD × FUNCTIONCODE × OPERATIONCODE, ekibin paneli), toplam
// bucket'ında FUNCTIONCODE tag'ı DOĞRULANMADI; oran kanal × operasyonda kalır.
