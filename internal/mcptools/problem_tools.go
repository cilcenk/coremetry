...
func getProblemTool(d Deps) mcp.Tool {
	return mcp.Tool{
		Name:             "get_problem",
		ShortDescription: "Tek Problem'in tam kaydı (id): özne, ölçü/eşik/değer, durum, atanan, süre, ekipler, yakın deploy.",
...
func similarProblemsTool(d Deps) mcp.Tool {
	return mcp.Tool{
		...
		ShortDescription: "Aynı (servis, kural) anahtarında çözülmüş geçmiş problemler: ne zaman, süre, kim aldı.",
...
func getCapabilitiesTool(d Deps) mcp.Tool {
	return mcp.Tool{
		...
		ShortDescription: "Bu kurulumda açık katmanlar: entity, rollouts, Thanos, metrik/log deposu, RAG, model. Kapalı katmanın tool'unu çağırma.",
