...
DROP TABLE IF EXISTS entity_seen_1m ON CLUSTER uptrace_all;
DROP TABLE IF EXISTS entity_seen_1m_local ON CLUSTER uptrace_all;
DROP TABLE IF EXISTS entity_seen_5m ON CLUSTER uptrace_all;
DROP TABLE IF EXISTS entity_seen_5m_local ON CLUSTER uptrace_all;

DROP TABLE IF EXISTS entity_sync_runs ON CLUSTER uptrace_all;
DROP TABLE IF EXISTS entity_relations ON CLUSTER uptrace_all;
DROP TABLE IF EXISTS entities ON CLUSTER uptrace_all;
